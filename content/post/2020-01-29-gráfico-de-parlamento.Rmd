...
Para esta tarea vamos a hacer de dos paquetes principalmente: el viejo conocido `tidyverse` y también de `ggpol`, una extensión de ggplot2 desarrollada especialmente para este tipo de gráficos. `ggforce` nos servirá al final sólo para una mejora estética.
